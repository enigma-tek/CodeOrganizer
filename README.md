***Current Version 1.0.2 - Fixed a bug in the homepage on load mechanis that pointed to the wrong folder to check for updater updates. Home Page adjustments made for getting ready for Links section addition. Home page added clickable count boxes takes you directly to the codehub section of choice.
