# Code Organizer for PowerShell, KQL and SQL
...
The idea behind Code Organizer is to have an easy to use, easy to search and easy to read site running locally (for your own repo). (If there is enough feedback about the need for a Team or SErver based version, I am willing to put a version for that out)
